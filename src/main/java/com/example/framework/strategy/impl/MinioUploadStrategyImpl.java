...
import com.example.framework.config.properties.MinioProperties;
    ...
    public boolean exists(String filePath) {
        ...
        try {
            getMinioClient().statObject(StatObjectArgs.builder()
                    .bucket(minioProperties.getBucketName()).object(filePath).build());
        }catch (Exception e){
            exist = false;
        }
        return exist;
